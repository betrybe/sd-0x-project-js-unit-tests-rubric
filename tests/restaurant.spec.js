...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    const test2 = objetoRetornado2.fetchMenu() // Retorno: { food: {}, drink: {}}
    assert.deepStrictEqual(test2, { food: {}, drink: {} });
    // ```
    // TESTE 3: Verifique que o menu passado pra função createMenu é identico ao menu recuperado pela função 'objetoRetornado.fetchMenu'
    // ```
    const objetoRetornado3 = createMenu({ food: {}, drink: {}, cake: {} });
    const test3 = objetoRetornado3.fetchMenu() // Retorno: objetoQualquer
    assert.deepStrictEqual(test3, { food: {}, drink: {}, cake: {} });
    // ```
    // Agora faça o PASSO 1 no arquivo `src/restaurant.js`.
    // --------------------------------------------------------------------------------------
    // TESTE 4: Verifique que 'objetoRetornado.consumption', após a criação do menu, retorna um array vazio.
    // ```
    const objetoRetornado4 = createMenu({ food: {}, drink: {}, cake: {} });
    ...
    // ```
    const objetoRetornado5 = createMenu({ food: {}, drink: {}, cake: {} });
