...
describe('#productDetails', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    const idProductZero = products[0].details.productId;
    const idProductOne = products[1].details.productId
    assert.strictEqual(idProductZero.endsWith('123'), true);
    assert.strictEqual(idProductOne.endsWith('123'), true);
  });
});
